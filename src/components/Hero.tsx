...
const Hero = () => {
  return <section id="home" className="relative min-h-screen flex items-center bg-gradient-to-br from-primary/10 via-background to-accent/10">
      {/* Background pattern */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-foreground">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              ...
              <Button size="lg" variant="outline" className="text-lg px-8 hover:bg-muted/60 text-foreground" onClick={() => document.getElementById('contact')?.scrollIntoView({
              behavior: 'smooth'
            })}>
                Contact Us Today
              </Button>
          ...
          <div className="hidden lg:flex justify-center">
            <div className="relative">
              ...
              <div className="bg-card rounded-2xl overflow-hidden border border-border">
                ...
                />
                <div className="p-6 text-center text-card-foreground">
              ...
              <div className="absolute -bottom-4 -left-4 bg-muted rounded-full p-4 border border-border">
        ...
        {/* Stats - Full Width */}
        <div className="mt-4 pt-3 border-t border-border py-[3px] my-[6px]">
