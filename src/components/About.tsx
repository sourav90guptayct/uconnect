          ...
          >
            <div className="grid grid-cols-2 gap-5">
              <div className="col-span-2 relative rounded-2xl overflow-hidden mb-2 premium-shadow">
                <img src="/lovable-uploads/839cd676-3d03-4ff0-941b-4baee8220c7b.webp" alt="Enterprise Team" className="w-full h-52 object-cover" />
              ...
              <div className="col-span-2 relative rounded-2xl overflow-hidden premium-shadow">
                <img src="/lovable-uploads/8fc1a4ec-6d54-4375-b1f4-6c972127e11e.webp" alt="Professional Work Environment" className="w-full h-32 object-cover" />
