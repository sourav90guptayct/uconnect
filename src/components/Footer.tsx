      ...
      <div className="container mx-auto px-4 py-16">
        <div className="grid lg:grid-cols-5 md:grid-cols-2 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {["ConnectLH™ Antennas", "FTTH Products", "Optic Fiber Cables", "RF Cables", "Network & Data Cables", "Specialized Cables", "AC & DC PoE", "Racks & Cabinets", "BTS Products", "Industrial Routers", "Industrial Switches"].map((s, i) => (
                <li key={i}>
